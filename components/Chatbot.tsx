...
export default function Chatbot() {
  ...
  const quickReplies = [
    ...
    { label: 'Latest security article', value: 'africa security' },
  ...
  const predefinedResponses: { [key: string]: string } = {
    ...
    'security': 'Our Security & Solitary Solutions include armored vehicles, security equipment, and special-purpose vehicles. We work closely with government agencies. We are fully licensed under DICON (Defence Industries Corporation of Nigeria) and have delivered over 1000 armored vehicles to Nigerian security forces. Check out our latest article "Building Africa\'s Security Future" for more details.',
    ...
    'dicon': 'We are fully licensed under DICON (Defence Industries Corporation of Nigeria) for armored vehicle assembly and security equipment production. Our Abuja facility produces world-class tactical vehicles and we have delivered over 1000 armored vehicles to Nigerian security forces.',
    'africa security': 'We are redefining African security with locally assembled armored vehicles, integrated surveillance systems, and advanced training. Our goal is to build Africa\'s security future on African soil, by African hands. Check out our latest article "Building Africa\'s Security Future" for comprehensive details.',
    ...
    'price': 'For pricing information, please contact our sales team at info@viniciusint.com or call +234 70x xxx xxxx. We provide customized quotes based on your specific requirements.',
    ...
    'default': 'Thank you for your question. For detailed information, please contact us at info@viniciusint.com or call +234 70x xxx xxxx. Our team will be happy to assist you!'
  };
